...
class GenerateTeamInvitationUseCaseTest {
    ...
    private val team = Team(id = "team_fs_1", name = "Team A", coachName = "Coach", delegateName = "Del", teamType = TeamType.FOOTBALL_7, clubId = "club_fs_1")
    private val presidentMember = ClubMember(id = "1", userId = "user1", name = "President", email = "president@test.com", clubId = "club_fs_1", roles = listOf(ClubRole.PRESIDENT.roleName))
