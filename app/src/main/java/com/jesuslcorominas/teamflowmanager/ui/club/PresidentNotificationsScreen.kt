            ...
            if (!notification.read) {
                IconButton(onClick = onMarkRead) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.notifications_mark_read_description),
                    )
                }
            } else {
                IconButton(onClick = onMarkUnread) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.notifications_mark_unread_description),
                    )
                }
            }
