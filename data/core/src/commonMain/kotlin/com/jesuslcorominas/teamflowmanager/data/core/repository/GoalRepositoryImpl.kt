...
internal class GoalRepositoryImpl(
    ...
    override fun getMatchGoals(matchId: Long): Flow<List<Goal>> = goalDataSource.getMatchGoals(matchId)

    override fun getAllTeamGoals(): Flow<List<Goal>> = goalDataSource.getAllTeamGoals()

    override suspend fun insertGoal(goal: Goal): Long = goalDataSource.insertGoal(goal)
}
