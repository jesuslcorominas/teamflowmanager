...
class AssignCoachToTeamUseCaseTest {
    ...
    private val team = Team(id = "team_fs_1", name = "Team A", coachName = "", delegateName = "Del", teamType = TeamType.FOOTBALL_7, clubId = "club_fs_1")
    private val presidentMember = ClubMember(id = "1", userId = "user1", name = "President", email = "pres@test.com", clubId = "club_fs_1", roles = listOf(ClubRole.PRESIDENT.roleName))
    private val coachMember = ClubMember(id = "2", userId = "coach1", name = "Coach", email = "coach@test.com", clubId = "club_fs_1", roles = listOf(ClubRole.STAFF.roleName))
    ...
    fun `givenPresidentInDifferentClubThanTeam_whenInvoke_thenThrowIllegalArgumentException`() = runTest {
        val memberInDifferentClub = presidentMember.copy(clubId = "different_club_fs")
        coEvery { getCurrentUser() } returns flowOf(president)
        coEvery { teamRepository.getTeamById("team_fs_1") } returns team
